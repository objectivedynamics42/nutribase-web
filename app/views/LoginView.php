...
class LoginView {
    ...
    public function renderLogin(): string {
        $content = renderHeader("/nutribase", "TODO", "Login");  //TODO what backLink should we use here?
    ...
    public function renderLoggedIn(){
        $content = renderHeader("/nutribase", "TODO", "Logged in");  //TODO what backLink should we use here?
        $content .= "<div class=\"row mt-4\"><div class=\"col\"><ul class=\"list-group\">";
